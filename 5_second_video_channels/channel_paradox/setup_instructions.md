# Paradox Science Setup Instructions
...
```bash
python batch_generate.py channel_paradox --count 100
```
...
- **Local Render Only**:
  ```bash
  python run_channel.py channel_paradox
  ```
- **Render and Auto-Upload**:
  ```bash
  python run_channel.py channel_paradox --upload
  ```
