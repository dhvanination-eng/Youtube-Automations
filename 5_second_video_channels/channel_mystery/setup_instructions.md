# Midnight Mystery Files Setup Instructions
...
```bash
python batch_generate.py channel_mystery --count 100
```
...
- **Local Render Only**:
  ```bash
  python run_channel.py channel_mystery
  ```
- **Render and Auto-Upload**:
  ```bash
  python run_channel.py channel_mystery --upload
  ```
