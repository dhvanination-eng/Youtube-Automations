# Forgotten Mythology Setup Instructions
...
```bash
python batch_generate.py channel_mythology --count 100
```
...
- **Local Render Only**:
  ```bash
  python run_channel.py channel_mythology
  ```
- **Render and Auto-Upload**:
  ```bash
  python run_channel.py channel_mythology --upload
  ```
