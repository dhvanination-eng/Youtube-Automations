# Retro Tech Nostalgia Setup Instructions
...
```bash
python batch_generate.py channel_nostalgia --count 100
```
...
- **Local Render Only**:
  ```bash
  python run_channel.py channel_nostalgia
  ```
- **Render and Auto-Upload**:
  ```bash
  python run_channel.py channel_nostalgia --upload
  ```
