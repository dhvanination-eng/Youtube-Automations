# Stoic Wisdom Setup Instructions
...
```bash
python batch_generate.py channel_stoic --count 100
```
...
- **Local Render Only**:
  ```bash
  python run_channel.py channel_stoic
  ```
- **Render and Auto-Upload**:
  ```bash
  python run_channel.py channel_stoic --upload
  ```
